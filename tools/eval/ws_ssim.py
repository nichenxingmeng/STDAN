...
def compute_ssim(img_mat_1, img_mat_2):
    ...
    img_mat_sigma_1_sq = scipy.ndimage.convolve(img_mat_1_sq,
                                                        gaussian_kernel)
    img_mat_sigma_2_sq = scipy.ndimage.convolve(img_mat_2_sq,
                                                        gaussian_kernel)

    # Covariance
    img_mat_sigma_12 = scipy.ndimage.convolve(img_mat_12,
                                                      gaussian_kernel)
